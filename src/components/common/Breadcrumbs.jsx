...
const Breadcrumbs = () => {
  ...
  return (
    <nav className="flex items-center text-sm text-slate-500 mb-4 animate-in fade-in slide-in-from-left-4 duration-500">
      <Link 
        to="/dashboard" 
      ...
      {pathnames.map((name, index) => {
        ...
        // Skip 'dashboard' if it appears in the path since we handled it manually
